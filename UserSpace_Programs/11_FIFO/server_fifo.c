...
{
	printf("Welcome to server application program using FIFO\n");
	...
	printf("Server FIFO is created_%d\n",getpid());
	...
	if (dummyFd == -1)
		fprintf(stderr,"open %s", SERVER_FIFO);
	printf("Server FIFO is ready to read from clients\n");
