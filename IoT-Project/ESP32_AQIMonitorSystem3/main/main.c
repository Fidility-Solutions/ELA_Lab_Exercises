...
void read_and_print_device_info(void)
{
	...
	printf("Hardware version: %s\n", str_ble_param_config.ps8bleHVersion);
	printf("Software version: %s\n", str_ble_param_config.ps8bleSVersion);
	printf("Device ID	: %s\n", str_ble_param_config.as8bleDeviceId);
	printf("Location	: %s\n", str_ble_param_config.as8blelocation);
	printf("================================================================\n");
}
