/****************************************************************************
*  \file       ldd_static_major_minor.c
*
*  \details    Creating Major and Minor Numbers Statically
*
...
dev_t dev = MKDEV(195, 0);

/*
** Module Init function
*/
static int __init module_static_init(void)
{
...
*/
static void __exit module_static_exit(void)
{
    unregister_chrdev_region(dev, 1);
    pr_info("Kernel Module Removed Successfully...\n");
}
 
module_init(module_static_init);
module_exit(module_static_exit);
